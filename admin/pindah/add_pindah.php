	    ...
	    <form action="" method="post" enctype="multipart/form-data">
	        <div class="card-body">
	            <div class="form-group row">
	                ...
	                <div class="col-sm-6">
	                    <select name="id_pdd" id="id_pdd" class="form-control select2bs4" required autocomplete="off">
	            ...
	            <div class="form-group row">
	                <label class="col-sm-2 col-form-label" id="label">Tanggal Pindah</label>
	                <div class="col-sm-4">
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-sm-6">
	                    <textarea type="text" class="form-control" id="alasan" name="alasan" placeholder="Alasan Pindah"
