    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group row" hidden>
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="id_pindah" name="id_pindah"
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label" id="label">Tanggal</label>
                <div class="col-sm-4">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label" id="label">Alasan</label>
                <div class="col-sm-6">
                    <textarea type="text" class="form-control" id="alasan" name="alasan" cols="30" rows="3"
                        required><?php echo $data_cek['alasan']; ?></textarea>
                </div>
            </div>
